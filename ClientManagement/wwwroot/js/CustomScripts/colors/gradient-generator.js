...
var noOfColors = document.getElementById('steps');
...
function generateGradient(firstColorValue, secondColorValue, steps) {
    var firstColor = { value: firstColorValue };
    var secondColor = { value: secondColorValue };
    //attach start value
    firstColor.dataType = getType(firstColor.value);
    secondColor.dataType = getType(secondColor.value);

    var val1RGB = processValue(firstColor);
    var val2RGB = processValue(secondColor);
